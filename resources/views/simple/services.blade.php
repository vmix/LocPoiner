...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="keywords" content="services, responsive" />
	<meta name="author" content="CodePicker" />
	...
	<link rel="shortcut icon" href="{{ env('THEME') }}/favicon.ico">
	...
	<div id="fh5co-wrap">
		...
		<div class="fh5co-hero" style="background-image: url({{ asset(env('THEME')) }}/images/hero_2.jpg);" data-stellar-background-ratio="0.5">
